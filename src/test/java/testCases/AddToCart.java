...
import pageObjectModel.HambAddtocartObject;
...
public class AddToCart extends Baseclass {
	...
	@Test
	public void verifyADC() throws IOException, InterruptedException
	{
		...
		HambAddtocartObject hatc=new HambAddtocartObject(driver);
		
		hatc.clickonADC().click();
		
		Thread.sleep(1000);
		
		hatc.clickonCheckout().click();
